...
const STRIPE_PUBLISHABLE =
  "pk_test_51KkgQ1BHNzRaB25PEYP77hzfRdhQQhRyu58DiteDA7sHdE4QG5gsOQYzUG9JPvGtF0eBFEvH7ZyMEXqnn3Nc71xQ00u2WOqoGf";
...
const onToken = (amount, description) => (token) =>
  axios
    .post("http://localhost:8080/stripe", {
      description,
      source: token.id,
      currency: CURRENCY,
      amount: amount,
